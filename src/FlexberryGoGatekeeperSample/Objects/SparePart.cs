...
namespace IIS.FlexberryGoGatekeeperSample
{
    ...
    public class SparePart : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.FlexberryGoGatekeeperSample.ProducingCountry fProducingCountry;
        
        private IIS.FlexberryGoGatekeeperSample.Car fCar;
        ...
        public virtual IIS.FlexberryGoGatekeeperSample.ProducingCountry ProducingCountry
        {
            get
            {
                ...
                IIS.FlexberryGoGatekeeperSample.ProducingCountry result = this.fProducingCountry;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.FlexberryGoGatekeeperSample.Car.
        /// </summary>
        ...
        [Agregator()]
        [NotNull()]
        public virtual IIS.FlexberryGoGatekeeperSample.Car Car
        {
            get
            {
                ...
                IIS.FlexberryGoGatekeeperSample.Car result = this.fCar;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View SparePartE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("SparePartE", typeof(IIS.FlexberryGoGatekeeperSample.SparePart));
                }
            }
        }
    }
    ...
    public class DetailArrayOfSparePart : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.FlexberryGoGatekeeperSample.DetailArrayOfSparePart members)

        // *** End programmer edit section *** (IIS.FlexberryGoGatekeeperSample.DetailArrayOfSparePart members)
        ...
        /// </summary>
        public DetailArrayOfSparePart(IIS.FlexberryGoGatekeeperSample.Car fCar) : 
                base(typeof(SparePart), ((ICSSoft.STORMNET.DataObject)(fCar)))
        {
        }
        
        public IIS.FlexberryGoGatekeeperSample.SparePart this[int index]
        {
            get
            {
                return ((IIS.FlexberryGoGatekeeperSample.SparePart)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.FlexberryGoGatekeeperSample.SparePart dataobject)
        {
