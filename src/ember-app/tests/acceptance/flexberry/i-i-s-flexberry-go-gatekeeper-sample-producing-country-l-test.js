...
moduleForAcceptance('[AGAT] Acceptance | i i s flexberry go gatekeeper sample producing country l');

test('testing i-i-s-flexberry-go-gatekeeper-sample-producing-country-l', function(assert) {
  visit('/i-i-s-flexberry-go-gatekeeper-sample-producing-country-l');
