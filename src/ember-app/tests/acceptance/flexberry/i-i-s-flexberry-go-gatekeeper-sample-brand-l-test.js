...
moduleForAcceptance('[AGAT] Acceptance | i i s flexberry go gatekeeper sample brand l');

test('testing i-i-s-flexberry-go-gatekeeper-sample-brand-l', function(assert) {
  visit('/i-i-s-flexberry-go-gatekeeper-sample-brand-l');
