...
moduleForAcceptance('[AGAT] Acceptance | i i s flexberry go gatekeeper sample car l');

test('testing i-i-s-flexberry-go-gatekeeper-sample-car-l', function(assert) {
  visit('/i-i-s-flexberry-go-gatekeeper-sample-car-l');
