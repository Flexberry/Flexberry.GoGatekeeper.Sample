...
moduleForModel('i-i-s-flexberry-go-gatekeeper-sample-brand', 'Unit | Serializer | i-i-s-flexberry-go-gatekeeper-sample-brand', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-flexberry-go-gatekeeper-sample-brand',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
