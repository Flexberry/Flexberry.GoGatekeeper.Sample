...
moduleForAcceptance('[AGAT] Acceptance | i i s flexberry go gatekeeper sample user report l');

test('testing i-i-s-flexberry-go-gatekeeper-sample-user-report-l', function(assert) {
  visit('/i-i-s-flexberry-go-gatekeeper-sample-user-report-l');
