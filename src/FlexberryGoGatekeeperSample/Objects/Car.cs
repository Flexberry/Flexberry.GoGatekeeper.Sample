...
namespace IIS.FlexberryGoGatekeeperSample
{
    ...
    public class Car : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.FlexberryGoGatekeeperSample.CarType fCarBody;
        
        private System.DateTime fCarDate = System.DateTime.Parse("DateTime.Now");
        
        private string fCarNumber;
        
        private IIS.FlexberryGoGatekeeperSample.Brand fBrand;
        
        private IIS.FlexberryGoGatekeeperSample.DetailArrayOfSparePart fSparePart;
        ...
        public virtual IIS.FlexberryGoGatekeeperSample.CarType CarBody
        {
            get
            {
                ...
                IIS.FlexberryGoGatekeeperSample.CarType result = this.fCarBody;
        ...
        [NotNull()]
        public virtual IIS.FlexberryGoGatekeeperSample.Brand Brand
        {
            get
            {
                ...
                IIS.FlexberryGoGatekeeperSample.Brand result = this.fBrand;
        ...
        public virtual IIS.FlexberryGoGatekeeperSample.DetailArrayOfSparePart SparePart
        {
            get
            {
                ...
                {
                    this.fSparePart = new IIS.FlexberryGoGatekeeperSample.DetailArrayOfSparePart(this);
                }
                IIS.FlexberryGoGatekeeperSample.DetailArrayOfSparePart result = this.fSparePart;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View CarE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("CarE", typeof(IIS.FlexberryGoGatekeeperSample.Car));
                }
            }
            ...
            public static ICSSoft.STORMNET.View CarL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("CarL", typeof(IIS.FlexberryGoGatekeeperSample.Car));
                }
            }
        }
    }
