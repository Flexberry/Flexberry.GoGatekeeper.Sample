...
moduleForModel('i-i-s-flexberry-go-gatekeeper-sample-producing-country', 'Unit | Serializer | i-i-s-flexberry-go-gatekeeper-sample-producing-country', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-flexberry-go-gatekeeper-sample-producing-country',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
