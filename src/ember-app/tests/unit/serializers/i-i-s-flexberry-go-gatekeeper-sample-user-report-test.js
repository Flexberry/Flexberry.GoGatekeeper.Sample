...
moduleForModel('i-i-s-flexberry-go-gatekeeper-sample-user-report', 'Unit | Serializer | i-i-s-flexberry-go-gatekeeper-sample-user-report', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-flexberry-go-gatekeeper-sample-user-report',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
