...
moduleForModel('i-i-s-flexberry-go-gatekeeper-sample-spare-part', 'Unit | Serializer | i-i-s-flexberry-go-gatekeeper-sample-spare-part', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-flexberry-go-gatekeeper-sample-spare-part',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
